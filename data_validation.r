...
check_benthic_cover <- list(
    ...
    quote(check_range(df_benthic_cover$Temp, 25, 30, c("numeric"))),
...
check_recruits <- list(
    ...
    quote(check_range(df_recruits$Temp, 25, 30, c("numeric"))),
...
check_invertebrates <- list(
    ...
    quote(check_range(df_invertebrates$Temp, 25, 30, c("numeric"))),
...
check_relief <- list(
    ...
    quote(check_range(df_fish$Temp, 25, 30, c("numeric"))),
