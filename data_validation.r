...
checks_sites <- list(
    ...
    quote(check_range(df_sites$Depth, 0, 20, type = "numeric")),
    quote(check_range(df_sites$Latitude, 16.00000, 18.99999, type = "numeric")),
...
check_coral_community <- list(
    ...
    quote(check_range(df_coral_community$Temp, 25, 35, c("numeric"))),
    ...
    quote(check_range(df_coral_community$Start_Depth, 0, 20, c("numeric"))),
    quote(check_range(df_coral_community$End_Depth, 0, 20, c("numeric"))),
...
check_benthic_cover <- list(
    ...
    quote(check_range(df_benthic_cover$Temp, 25, 35, c("numeric"))),
    ...
    quote(check_range(df_benthic_cover$Start_Depth, 0, 20, c("numeric"))),
    quote(check_range(df_benthic_cover$End_Depth, 0, 20, c("numeric"))),
...
check_recruits <- list(
    ...
    quote(check_range(df_recruits$Temp, 25, 35, c("numeric"))),
    ...
    quote(check_grouping(df_recruits$Primary_Substrate, df_substrate$`Genus / Group`)),
    quote(check_grouping(df_recruits$Secondary_Substrate, df_substrate$`Genus / Group`)),
...
check_invertebrates <- list(
    ...
    quote(check_range(df_invertebrates$Temp, 25, 35, c("numeric"))),
...
check_relief <- list(
    ...
    quote(check_range(df_fish$Temp, 25, 35, c("numeric"))),
